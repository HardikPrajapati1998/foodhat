...
class PaymentMethodController extends Controller
{
    ...
    public function index(){
        ...
        return view('admin.payment_method', compact('paypal','eway','razorpay','bank','paystackAndMollie','flutterwave','instamojo','countires','currencies','setting','paymongo','sslcommerz'));
